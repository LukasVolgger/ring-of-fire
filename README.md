# Ring of Fire
Ring of Fire also known as Circle of Death is a drinking game with cards. By connecting to Google Firebase, the game is shared with others and up to 4 players can participate per game.
...
- Share the game invitation link
- Change your avatar
- Change the background image

## Preview

![Start](./src/assets/img/preview/start-min.png "Start Screen Preview")

---

![Game](./src/assets/img/preview/game-min.png "Game Preview")

---

![Game 2](./src/assets/img/preview/game_2-min.png "Game Preview 2")
...
``` bash
git clone https://github.com/LukasVolgger/ring-of-fire.git
```
...
- **Support Inquiry:** If you encounter difficulties or need assistance, [create a new GitHub issue](https://github.com/LukasVolgger/ring-of-fire/issues/new). Please describe your issue in detail to enable me to provide quick and accurate support.
