...
export class GameInfoComponent implements OnInit, OnChanges {
  ...
  cardAction = [
    ...
    { title: 'Quizmaster', description: 'You are now the quiz master, and if anybody answers a question asked by you (the player who drew the card), they have to drink. This applies to ANY question.' },
